    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Add a new professional profile for a different job role</p>
        </div>
      </div>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div>
            ...
            {availableResumes.length === 0 && (
              <p className="text-xs text-gray-500 mt-1">
                No resumes available. <Link href="/resume-manager" className="text-primary hover:underline">Upload a resume first</Link>.
              </p>
            )}
          </div>
