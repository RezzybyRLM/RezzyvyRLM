...
import { Menu, X, LogIn, Play, GraduationCap, Users, MessageSquare, Calendar, Trophy, Briefcase } from 'lucide-react';
import { supabase } from '@/lib/supabase/client';
import Link from 'next/link';
import { useMobileDetection } from './MobilePageWrapper';
            ...
            <div className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300">
              <div className="flex flex-col h-full">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                  {/* Core Navigation - Only show guest links when in guest mode */}
                  {guestMode && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {/* Core Navigation Links - Only show when in guest mode */}
            {guestMode && (
